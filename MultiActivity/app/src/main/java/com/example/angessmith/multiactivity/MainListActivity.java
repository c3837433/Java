...
/*
    ...
    DONE Add screen will allow the user to enter data and save that data to the list shown on the list screen using a save button in the action bar.
...
MASTERY
    DONE Overflow section of the action bar is utilized on the add screen to allow the user to reset the contents of the form.
